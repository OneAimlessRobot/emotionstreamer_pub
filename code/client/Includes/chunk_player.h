...
typedef enum play_op{P_SAFE_DECODER_BUFF_LOAD,P_REAL_PLAY,P_DRY_PLAY,P_PLAY_NA,P_GET_FRAME_DATA,P_INSERT_FRAME_DATA,P_PRINT_FRAME_DATA, P_INIT_LIBS,P_CLEAN,P_PARSE_WAV_HEADER_INTO_PLAYER_RESULT}play_op;
