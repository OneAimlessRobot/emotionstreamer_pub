...
#define REPORT_SENT_WITH_FILENAME "Ficheio \"%s\" reportado ao servidor!\n"
...
#define CONTENT_DOWNLOAD_INCOMMING "%ld bytes DO SERVER SERAO TRANFERIDOS!!\nA extensão de ficheiro é %s!\nAGUARDE!\n"
#define STREAM_INCOMMING "%ld bytes DO SERVER SERAO SERAM STREAMADOS por %s!!\nA extensão de ficheiro é %s!\nWAV mode? %s\nAGUARDE!\n"
