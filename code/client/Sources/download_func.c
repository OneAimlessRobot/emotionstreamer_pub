...
static void* print_download_bar(void* mem){
        ...
        for(int i=1;i<round((double)(bar_inside->curr*bar_inside->size+1)/(double)bar_inside->total);i++){
