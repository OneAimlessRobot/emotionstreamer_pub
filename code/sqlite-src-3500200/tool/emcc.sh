...
# configure process.
EMSDK_HOME="/mnt/FASTstorage/FASTprogs/emscr/emsdk"
EMSDK_ENV_SH="/mnt/FASTstorage/FASTprogs/emscr/emsdk/emsdk_env.sh"
emcc="/mnt/FASTstorage/FASTprogs/emscr/emsdk/upstream/emscripten/emcc"
